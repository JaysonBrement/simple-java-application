...
<body id="page-top">
	...
	<section>
		<div class="container px-4">
          ...
          <div class="text-end">
            <a type="button" class="btn btn-primary btn-md" href="/addForm">Ajouter Employé</a>
          </div>
					<table class="table">
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <td><a type="button" class="btn btn-success"
                                  href="/modify?id=${employee.employeeId}">Modifier</a>
                                <a type="button" class="btn btn-warning"
                                  href="/employees/delete?id=${employee.employeeId}">Supprimer</a></td>
                            </tr>
                          </c:forEach>
                        </tbody>
                      </table>
